...
async function testPermissionRole() {
  ...
  try {
    console.log('1. Creating 0-byte metadata file...');
    const createRes = await drive.files.create({
      requestBody: {
        name: 'test_perm_role.pdf',
    ...
    console.log('2. Giving writer role to bwnhmch@gmail.com...');
    ...
    console.log('Writer permission created.');

    console.log('3. Updating file content...');
