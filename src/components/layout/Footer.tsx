        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-5">
          ...
          <div className="space-y-4 md:col-span-2">
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs text-emerald-400 font-semibold">
              ...
              <span className="flex items-center gap-1"><Globe className="h-4 w-4" /> WBUHS Affiliated</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><Link to="/faculty-directory" className="hover:text-emerald-400 transition-colors">Faculty Directory</Link></li>
              <li><Link to="/courses" className="hover:text-emerald-400 transition-colors">BHMS & MD Courses</Link></li>
              <li><Link to="/admission" className="hover:text-emerald-400 transition-colors">Admission 2026</Link></li>
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-white mb-4">Official Contact</h4>
